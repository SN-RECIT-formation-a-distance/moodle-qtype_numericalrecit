...
/**
 * Unit tests for the numericalrecit qtype_numericalrecit_variables class.
 *
...
/**
 * Unit tests for the numericalrecit question variables class.
 *
 * @copyright  2018 Jean-Michel Vedrine
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

class qtype_numericalrecit_variables_test extends advanced_testcase {
    /**
    ...
    public function test_sigfig() {
        $number = .012345;
        $this->assertSame(QTypeNumericalRecitUtils::sigfig($number, 3), '0.0123');
        $this->assertSame(QTypeNumericalRecitUtils::sigfig($number, 4), '0.01235');
        $this->assertSame(QTypeNumericalRecitUtils::sigfig($number, 6), '0.0123450');
        $number = -.012345;
        $this->assertSame(QTypeNumericalRecitUtils::sigfig($number, 3), '-0.0123');
        $this->assertSame(QTypeNumericalRecitUtils::sigfig($number, 4), '-0.01235');
        $this->assertSame(QTypeNumericalRecitUtils::sigfig($number, 6), '-0.0123450');
        $number = 123.45;
        $this->assertSame(QTypeNumericalRecitUtils::sigfig($number, 2), '120');
        $this->assertSame(QTypeNumericalRecitUtils::sigfig($number, 4), '123.5');
        $this->assertSame(QTypeNumericalRecitUtils::sigfig($number, 6), '123.450');
        $number = -123.45;
        $this->assertSame(QTypeNumericalRecitUtils::sigfig($number, 2), '-120');
        $this->assertSame(QTypeNumericalRecitUtils::sigfig($number, 4), '-123.5');
        $this->assertSame(QTypeNumericalRecitUtils::sigfig($number, 6), '-123.450');
        $number = .005;
        $this->assertSame(QTypeNumericalRecitUtils::sigfig($number, 1), '0.005');
        $this->assertSame(QTypeNumericalRecitUtils::sigfig($number, 2), '0.0050');
        $this->assertSame(QTypeNumericalRecitUtils::sigfig($number, 3), '0.00500');
        $number = -.005;
        $this->assertSame(QTypeNumericalRecitUtils::sigfig($number, 1), '-0.005');
        $this->assertSame(QTypeNumericalRecitUtils::sigfig($number, 2), '-0.0050');
        $this->assertSame(QTypeNumericalRecitUtils::sigfig($number, 3), '-0.00500');
